      ...
      <div className="flex flex-col gap-10 items-center justify-center">
        ...
        <div className="flex flex-col px-4 w-full">
          <div
            ...
            className="flex items-center justify-center gap-1 bg-[#edaeb7] hover:bg-[#f797a6]  ml-[3rem] mb-4 text-center mx-auto pl-3 pr-1 py-3 rounded-xl drop-shadow-md cursor-pointer font-bold"
          >
            Add Item
