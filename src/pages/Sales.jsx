        ...
        <div className="flex flex-col mb-4 px-4 w-full">
          <div className="flex items-center gap-6 ml-[3rem] mb-4 text-center mx-auto">
            <div
              ...
              className="flex items-center justify-center gap-1 bg-[#edaeb7] hover:bg-[#f797a6] text-center mx-auto pl-3 pr-1 py-3 rounded-xl drop-shadow-md cursor-pointer font-bold"
            >
              Add Sale
